          ...
          <div className={styles.content}>
            <div className={styles.mainContent}>
              ...
              <p className={styles.content__text}>
                Управляющая организация — Кыргызский футбольный Союз, являющийся
                с 1994 года членом АФК и ФИФА, также член ФАЦА.
              </p>
              <p className={styles.content__text}>
              ...
              <p className={styles.content__text}>
                Домашние матчи команда проводит на стадионе имени Долона
                Омурзакова в Бишкеке, вмещающем 18 тысячи зрителей, и являющимся
                крупнейшим и главным стадионом страны.
              </p>
              <p className={styles.content__text}>
                По состоянию на конец 2021 года, Национальная сборная КР в
                рейтинге ФИФА занимала 96-е место среди 210 стран-членов ФИФА.
                Наивысшее место этой сборной в рейтинге ФИФА зафиксировано в
                апреле 2018 года, когда она занимала 75-е место, и самое низкое
                место зафиксировано в марте 2013 года, когда сборная занимала
                201-е место.
              </p>
              <p className={styles.content__text}>
                Сборная в 2018 году смогла пройти квалификацию и впервые в своей
                истории вышла на финальный этап Кубка Азии 2019 в ОАЭ. В
                последние два-три года поднялась на новый уровень, и стала
                хорошим игроком в азиатском континенте.
              </p>
            </div>
                  ...
                  ? firstData.map(({ name, image, id }) => {
                      return (
                        <li key={id} className={styles.playersList__item}>
                          ...
                          <span className={styles.playersItem__text}>
                            {name}
                          </span>
                        </li>
                      );
